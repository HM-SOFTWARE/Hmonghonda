...
if (isset($_POST['sqlsearch'])) {
    $date1 = $_POST['date1'];
    $date2 = $_POST['date2']; //between '" . $date1 . "' and '" . $date2 . "'
    //echo $date1;
    //echo $date2;
    //exit();


    $result = mysql_query("SELECT car_type.type_name as cartype, infon_car.car_code_1 as code1, infon_car.car_code_2 as code2, infon_car.color as color, infon_car.generation as lun, placard.date_note as date FROM `placard` inner join infon_car on placard.infon_car_id= infon_car.id INNER JOIN car_type on infon_car.car_type_id=car_type.id where placard.date_note is NOT null and  placard.date_note between '" . $date1 . "' and '" . $date2 . "'");
} else {

    $result = mysql_query("SELECT car_type.type_name as cartype, infon_car.car_code_1 as code1, infon_car.car_code_2 as code2, infon_car.color as color, infon_car.generation as lun, placard.date_note as date FROM `placard` inner join infon_car on placard.infon_car_id= infon_car.id INNER JOIN car_type on infon_car.car_type_id=car_type.id where placard.date_note is NOT null");
}
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="box">
                                    <div class="box box-info">
                                        <div class="box-header with-border">
                                            <h3 class="box-title" style="font-family:'Saysettha OT';">ຄົ້ນຫາລົດທີ່ແຈ້ງສັບສີນແລ້ວ</h3>
                                        </div>
                                ...
                                <div class="box">
                                    <div class="box-header">
                                        <h1 class="box-title" style="font-family:'Saysettha OT';">ລົດທີ່ແຈ້ງສັບສີນແລ້ວ</h1>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
