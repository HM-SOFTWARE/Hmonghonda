                            ...
                            <div class="box">
                                <div class="box box-info">
                                    ...
                                    if (isset($_POST['save'])) {
                                        ...
                                        $sql = mysql_query("update car_generation set generation='" . $generation . "' where id='" . $id . "'");
                                        //header("location:hmonghonda/customer/index.php");
                                    ...
                                    if (isset($_GET['generation_id'])) {
                                        ...
                                        $result = mysql_query("SELECT * from car_generation where id='" . $generation_id . "'");
                                        $i = 0;
                                        while ($row = mysql_fetch_array($result)) {
                                            ...
                                            <form class = "form-horizontal" method="post" role="form" action="edit.php">
                                                <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                                    <input type = "hidden" name="id" class = "form-control" id = "firstname" value="<?php echo $row['id']; ?>">

                                                    <div class = "form-group">
                                                        <label for = "generation" class = "col-sm-2 control-label">ລຸ້ນລົດ</label>

                                                        <div class = "col-sm-6">
                                                            <input type = "text" name="generation" class = "form-control" id = "firstname" value="<?php echo $row['generation']; ?>">
                                                        </div>
                                                    </div>
