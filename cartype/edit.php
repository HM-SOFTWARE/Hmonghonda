                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box box-info">
                                    ...
                                    if (isset($_POST['save'])) {
                                        $id = $_POST['id'];
                                        $cartype = $_POST['type_name'];
                                        $sql = mysql_query("update car_type set type_name='" . $cartype . "' where id='" . $id . "'");
                                    ...
                                    if (isset($_GET['cartype_id'])) {
                                        ...
                                        $result = mysql_query("SELECT * from car_type where id='" . $cartype_id . "'");
                                        $i = 0;
                                            ...
                                            <form class = "form-horizontal" method="post" role="form" action="edit.php">
                                                <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                                    ...
                                                    <div class = "form-group">
                                                        <label for = "firstname" class = "col-sm-2 control-label">ຊື່</label>

                                                        <div class = "col-sm-6">
                                                            <input type = "text" name="type_name" class = "form-control" id = "firstname" value="<?php echo $row['type_name']; ?>">
                                                        </div>
                                                    </div>
