                            ...
                            <div class="box">
                                <div class="box box-info">
                                    <div class="box-header with-border">
                                        <h3 class="box-title" style="font-family:'Saysettha OT';">ຂໍ້ມູນປະເພດລົດ</h3>
                                    </div>
                                    ...
                                    if (isset($_POST['save'])) {
                                        ...
                                        $sql = mysql_query("insert into car_type values ('','$car_type')");
                                    ...
                                    <form class = "form-horizontal" method="post" role="form" action="index.php">
                                        <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                            ...
                                            <div class = "form-group">
                                                <label for = "cartype" class = "col-sm-2 control-label">ປະເພດ</label>

                                                <div class = "col-sm-6">
                                                    <input type = "text" name="cartype" class = "form-control" id = "firstname" placeholder="ປະເພດລົດ">
                                                </div>
                                            </div>
                                ...
                                <div class="box-body">
                                    <table id="example1"  class="table table-bordered table-striped" style="font-family:'Saysettha OT';font-size: 14px;">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysql_query("SELECT * from car_type");
                                            $i = 0;
                                            while ($row = mysql_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a href="edit.php?cartype_id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span></a>
                                                        <a href="delete.php?cartype_id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
