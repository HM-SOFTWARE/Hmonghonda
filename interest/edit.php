...
if (isset($_POST['save'])) {
    ...
    $sql = mysql_query("update interest set interest='" . $interest . "' where id='" . $id . "'");
...
if (isset($_GET['interest_id'])) {
    ...
    $result = mysql_query("SELECT * from interest where id='" . $interest_id . "'");
    $i = 0;
                                            ...
                                            <form class = "form-horizontal" method="post" role="form" action="edit.php">
                                                <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                                    ...
                                                    <div class = "form-group">
                                                        <label for = "interest" class = "col-sm-2 control-label">ອັດຕາດອກເບ້ຍ</label>

                                                        <div class = "col-sm-6">
                                                            <input type = "text" name="interest" class = "form-control" id = "firstname" value="<?php echo $row['interest']; ?>">
                                                        </div>
                                                    </div>
