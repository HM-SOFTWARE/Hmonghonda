                            ...
                            <div class="box">
                                <div class="box box-info">
                                    ...
                                    if (isset($_POST['save'])) {
                                        $id = $_POST['id'];
                                        $color = $_POST['color'];
                                        $sql = mysql_query("update car_color set color='" . $color . "' where id='" . $id . "'");
                                    ...
                                    if (isset($_GET['color_id'])) {
                                        ...
                                        $result = mysql_query("SELECT * from car_color where id='" . $color_id . "'");
                                        $i = 0;
                                            ...
                                            <form class = "form-horizontal" method="post" role="form" action="edit.php">
                                                <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                                    ...
                                                    <div class = "form-group">
                                                        <label for = "color" class = "col-sm-2 control-label">ສີ</label>

                                                        <div class = "col-sm-6">
                                                            <input type = "text" name="color" class = "form-control" id = "firstname" value="<?php echo $row['color']; ?>">
                                                        </div>
                                                    </div>
