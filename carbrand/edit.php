                            ...
                            <div class="box">
                                <div class="box box-info">
                                    ...
                                    if (isset($_POST['save'])) {
                                        $id = $_POST['id'];
                                        $brand = $_POST['brand'];
                                        $sql = mysql_query("update brand set brand_name='" . $brand . "' where id='" . $id . "'");
                                    ...
                                    if (isset($_GET['brand_id'])) {
                                        ...
                                        $result = mysql_query("SELECT * from brand where id='" . $brand_id . "'");
                                        $i = 0;
                                            ...
                                            <form class = "form-horizontal" method="post" role="form" action="edit.php">
                                                <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                                    ...
                                                    <div class = "form-group">
                                                        <label for = "brand" class = "col-sm-2 control-label">ຍີຫໍ້</label>

                                                        <div class = "col-sm-6">
                                                            <input type = "text" name="brand" class = "form-control" id = "firstname" value="<?php echo $row['brand_name']; ?>">
                                                        </div>
                                                    </div>
