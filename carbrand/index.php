                            ...
                            <div class="box">
                                <div class="box box-info">
                                    <div class="box-header with-border">
                                        <h3 class="box-title" style="font-family:'Saysettha OT';">ຂໍ້ມູນຍີ່ຫໍ້ລົດລົດ</h3>
                                    </div>
                                    ...
                                    if (isset($_POST['save'])) {
                                        ...
                                        $sql = mysql_query("insert into brand values ('','$brand_name')");
                                    ...
                                    <form class = "form-horizontal" method="post" role="form" action="index.php">
                                        <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                            ...
                                            <div class = "form-group">
                                                <label for = "cartype" class = "col-sm-2 control-label">ຍີ່ຫໍ້ລົດ</label>

                                                <div class = "col-sm-6">
                                                    <input type = "text" name="brand_name" class = "form-control" id = "firstname" placeholder="ຍີ່ຫໍ້ລົດ">
                                                </div>
                                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysql_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a href="edit.php?brand_id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span></a>
                                                        <a href="delete.php?brand_id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
