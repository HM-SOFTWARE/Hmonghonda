    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                            ...
                            <div class="box">
                                <div class="box box-info">
                                    <div class="box-header with-border">
                                        <h3 class="box-title" style="font-family:'Saysettha OT';">ແກ້ໄຂປະເພດລົດ</h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <?php
                                    if (isset($_POST['save'])) {
                                        ...
                                        $sql = mysql_query("update branch set branch_name='" . $branch . "', tel='" . $tel . "', mobile='" . $mobile . "', address='" . $address . "', district_id='" . $district_id . "', province_id='" . $province_id . "' where id='" . $id . "'") or die(mysql_error());
                                    ...
                                    if (isset($_GET['branch_id'])) {
                                        ...
                                        $result = mysql_query("SELECT * from branch where id='" . $branch_id . "'");
                                        $i = 0;
                                        while ($rows = mysql_fetch_array($result)) {
                                            ...
                                            <form class = "form-horizontal" method="post" role="form" action="edit.php">
                                                <div class = "box-body" style = "font-family:'Saysettha OT';font-size: 14px;">
                                                    <input type = "hidden" name="id" class = "form-control" id = "firstname" value="<?php echo $rows['id']; ?>">

                                                    <div class = "form-group">
                                                        <label for = "branch" class = "col-sm-2 control-label">ສາຂາ</label>

                                                        <div class = "col-sm-4">
                                                            <input type = "text" name="branch" class = "form-control" id = "firstname" value="<?php echo $rows['branch_name']; ?>">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" value="<?php echo $rows['address']; ?>" class="form-control" name="address" style="font-family:'Saysettha OT';font-size: 14px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" name="mobile" value="<?php echo $rows['mobile']; ?>" class="form-control" style="font-family:'Saysettha OT';font-size: 14px;">
                                                        </div>

                                                        <label for = "tel" class = "col-sm-2 control-label">Fax</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" value="<?php echo $rows['tel']; ?>" class="form-control" name="tel" style="font-family:'Saysettha OT';font-size: 14px;">
                                                        </div>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">HMONG HONDA </a>.</strong> All rights
                reserved.
            </footer>
