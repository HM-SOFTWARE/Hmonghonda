...
class PaymentInController extends Controller {
    ...
    public function actionReportpayin() {
        $this->render('reportpayin');
    }

    public function actionLock($id) {
        PaymentIn::model()->updateByPk($id, array('status' => 'Pending'));
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['PaymentIn'])) {
            ...
            $model->amonut = substr(preg_replace("/[^0-9]/", "", $model->amonut), 0, -2);
    ...
    public function actionUpdate($id) {
        $model = $this->loadModel($id);
        $model->amonut = number_format($model->amonut, 2);
        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);
    ...
    public function actionStaff() {
        $model = Staff::model()->findAll(array('order' => 'branch_id'));
