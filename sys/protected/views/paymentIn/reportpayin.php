...
<div class="col-md-12" style=" border-bottom: 1px solid #b71113"><h1>ລາຍ​ງານ​ລາຍ​ລະ​ອຽດ​ການ​ຈ່າຍ</h1></div>
&nbsp;
<div class="row" >
    <div class="col-md-12">
        ຈາກວັນ​ທີ: <?php
...
<div class="table-responsive" > 
    <table class="table table-bordered " id="pdf_export" >
        <tr> 
            ...
            <th style="white-space: nowrap">ລາຍ​ລະ​ອຽດ​ລາຍ​ຈ່າຍ</th>
                ...
                if (count($payins) > 0) {
                    ...
                    foreach ($payins as $payin) {
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap"><?= $payin->detail ?></td>
                            <td style="white-space: nowrap"><?= number_format($payin->amonut, 2) ?></td>
                        </tr>
                        <?php
                    }
                    ?>
