...
?>
<div class="col-md-12" style=" border-bottom: 1px solid #b71113"><h1>ລາຍ​ງານ​ລົດ​ທີ​່ໂອນໃຫ້​ສາ​ຂາ</h1></div>
&nbsp;
<div class="row" >
    <div class="col-md-5">
        ຈາກວັນ​ທີ: <?php
...
<div class="table-responsive" > 
    <table class="table table-bordered " id="pdf_export" >
        <tr> 
            ...
            <th style="white-space: nowrap">ວັນ​ທີໂອນ</th>
            ...
            <th  style="white-space: nowrap">​ລຸ້ນ</th>
        ...
        if (isset($_POST['search'])) {
            ...
            foreach ($branch as $branchs) {
                ...
                $criteria->compare('carSales.sale_status_id', 4);
                ...
                if (count($cars) > 0) {
                    ...
                    foreach ($cars as $car) {
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap" data-toggle="tooltip" title="ວັນ​ທີໂອນ"><?= $car->date_out ?></td>
                            <td style="white-space: nowrap" data-toggle="tooltip" title="ສະ​ຖາ​ນະ">
                                <?php
                                $status_pay = SaleStatus::model()->findByPk(4);
                            ...
                            <td style="white-space: nowrap" data-toggle="tooltip" title="​ລຸ້ນ"><?= $car->generation ?></td>
                            <td data-toggle="tooltip" title="​ຈຳນວນ">1</td>
                            <td style="white-space: nowrap" data-toggle="tooltip" title="ຈຳ​ນວນ​ເງີນ"><?= number_format($car->car_price_sale, 2) ?></td>

                            <td style="white-space: nowrap" data-toggle="tooltip" title="ຊື່​ຜູ້​ໂອນ">
                                <?php
                                $user = User::model()->findByPk($carsale->user_id);
                                echo $user->first_name . " " . $user->last_name;
                                ?>
                            </td>
                            <td style="white-space: nowrap" data-toggle="tooltip" title="ສາ​ຂາ">
                                <?php
