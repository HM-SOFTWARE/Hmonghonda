...
?>
<div id="myDiv">
    <div class="col-md-12" style=" border-bottom: 1px solid #b71113"><h1>ພ້ອມປ້າຍ</h1></div>
    &nbsp;
    <div class="row" >
        <div class="col-md-6">
            ຈາກວັນ​ທີ: 
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            <tr>
                ...
                <th style="white-space: nowrap">ວັນ​ທີຂືນທະບຽບ</th>
                <th style="white-space: nowrap">ຈຳ​ນວນ​ເງີນ</th>
                <th style="white-space: nowrap">ຊື່​ລູກ​ຄ້າ</th>
                <th style="white-space: nowrap"></th>
            </tr>
            <?php
            $placard = Placard::model()->findAll('date_note  IS NOT NULL and date_placars IS NOT NULL');
            $array = array();
            ...
            foreach ($branch as $branchs) {
                ...
                //  $criteria->addCondition('placards.date_placars IS NOT NULL');
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (!empty($placardp->date_placars)) {
                                    echo date('d/m/Y', strtotime($placardp->date_placars));
                                }
                                ?>
                            </td>
                            <td><?= $placardp->pay_placar ?></td>
                            ...
                            <td>
                                <?=
                                CHtml::ajaxLink('LP', Yii::app()->createUrl("infonCar/runpai&id=$placardp->id"), array('update' => '#view', 'beforeSend' => 'function(){
      ...
      $("#myDiv").removeClass("loading");}',), array('class' => 'btn btn-success',))
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td ><b><?= number_format($total_placar, 2) ?></b></td>
                    </tr>
                    <?php
                }
            }
