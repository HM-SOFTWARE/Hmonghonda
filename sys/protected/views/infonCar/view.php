            ...
            <div class="modal-body">
                ...
                $this->widget('zii.widgets.CDetailView', array(
                    ...
                    'attributes' => array(
                        ...
                        array(
                            'name' => 'generation',
                        //   'value' => CarGeneration::model()->findByPk($model->car_generation_id)->generation,
                        ),
                        array(
                            'name' => 'brand',
                        //  'value' => Brand::model()->findByPk($model->Brand_id)->brand_name,
                        ),
                        'car_code_1',
                        'car_code_2',
                        array(
                            'name' => 'color',
                        // 'value' => CarColor::model()->findByPk($model->car_color_id)->color,
                        ),
                        array(
                            'name' => 'car_price_buy',
                            'value' => number_format($model->car_price_buy, 2),
                        ),
                        array(
                            'name' => 'car_price_sale',
