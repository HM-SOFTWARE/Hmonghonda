    ...
    public function init() {
        ...
        $default_options = array(
            ...
            'monthNamesShort' => array(
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 1'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 2'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 3'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 4'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 5'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 6'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 7'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 8'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 9'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 10'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 11'),
                Yii::t('EJuiMonthPicker.EJuiMonthPicker', 'ເດືອນ 12'),
